...
/*!
  ...
  */
!function (t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(exports, require("jquery"), require("error-404.html")) : "function" == typeof define && define.amd ? define(["exports", "jquery", "popper.js"], e) : e((t = t || self).bootstrap = {}, t.jQuery, t.Popper)
}(this, function (t, g, u) {
    "use strict";
...
!function (a) {
    ...
    var b, c, d, e, f, g, h = "Close", i = "BeforeClose", j = "AfterClose", k = "BeforeAppend", l = "MarkupParse",
        ...
        t = function () {
            ...
            var a = document.createElement("p").style, b = ["ms", "O", "Moz", "Winkit"];
...
!function (t) {
    ...
    var i = "Winkit Moz ms Ms O".split(" "), n = document.documentElement.style;
...
!function (a, b, c, d) {
    ...
    var g = a("<support>").get(0).style, h = "Winkit Moz O ms".split(" "), i = {
        transition: {
            end: {
                WinkitTransition: "WinkitTransitionEnd",
                MozTransition: "transitionend",
...
var Industry = function () {
    ...
    return {
        init: function () {
            ...
            }), $(".full-height").css("height", $(window).height()), function () {
                if ($(".setResizeMargin").length > 0 && e >= 1280) {
                    var t = $(".container").width(), i = (e - t) / 2;
            ...
            !function () {
                ...
                if (jQuery("#masonry3").length) {
                    ...
                    i.imagesLoaded(function () {
                        i.masonry({gutterWidth: 15, isAnimated: !0, itemSelector: ".card-container"})
                ...
                if (jQuery("#masonry4").length) {
                    ...
                    r.imagesLoaded(function () {
                        r.masonry({gutterWidth: 15, isAnimated: !0, itemSelector: ".card-container"})
                ...
                if (jQuery("#masonry5").length) {
                    ...
                    n.imagesLoaded(function () {
                        n.masonry({gutterWidth: 15, isAnimated: !0, itemSelector: ".card-container"})
                ...
                if (jQuery("#masonry6").length) {
                    ...
                    a.imagesLoaded(function () {
                        a.masonry({gutterWidth: 15, isAnimated: !0, itemSelector: ".card-container"})
                ...
                if (jQuery("#masonry7").length) {
                    ...
                    s.imagesLoaded(function () {
                        s.masonry({gutterWidth: 15, isAnimated: !0, itemSelector: ".card-container"})
                ...
                if (jQuery("#masonry8").length) {
                    ...
                    o.imagesLoaded(function () {
                        o.masonry({gutterWidth: 15, isAnimated: !0, itemSelector: ".card-container"})
                ...
                if (jQuery("#masonry9").length) {
                    ...
                    l.imagesLoaded(function () {
                        l.masonry({gutterWidth: 15, isAnimated: !0, itemSelector: ".card-container"})
                ...
                if (jQuery("#masonry10").length) {
                    ...
                    u.imagesLoaded(function () {
                        u.masonry({gutterWidth: 15, isAnimated: !0, itemSelector: ".card-container"})
                ...
                if (jQuery("#masonry11").length) {
                    ...
                    c.imagesLoaded(function () {
                        c.masonry({gutterWidth: 15, isAnimated: !0, itemSelector: ".card-container"})
                ...
                if (jQuery("#masonry12").length) {
                    ...
                    d.imagesLoaded(function () {
                        d.masonry({gutterWidth: 15, isAnimated: !0, itemSelector: ".card-container"})
                ...
                if (jQuery("#masonry13").length) {
                    ...
                    f.imagesLoaded(function () {
                        f.masonry({gutterWidth: 15, isAnimated: !0, itemSelector: ".card-container"})
                ...
                if (jQuery("#masonry14").length) {
                    ...
                    h.imagesLoaded(function () {
                        h.masonry({gutterWidth: 15, isAnimated: !0, itemSelector: ".card-container"})
                ...
                if (jQuery("#masonry15").length) {
                    ...
                    m.imagesLoaded(function () {
                        m.masonry({gutterWidth: 15, isAnimated: !0, itemSelector: ".card-container"})
                ...
                if (jQuery("#masonry16").length) {
                    ...
                    y.imagesLoaded(function () {
                        y.masonry({gutterWidth: 15, isAnimated: !0, itemSelector: ".card-container"})
                ...
                if (jQuery("#masonry17").length) {
                    ...
                    g.imagesLoaded(function () {
                        g.masonry({gutterWidth: 15, isAnimated: !0, itemSelector: ".card-container"})
                ...
                if (jQuery("#masonry18").length) {
                    ...
                    p.imagesLoaded(function () {
                        p.masonry({gutterWidth: 15, isAnimated: !0, itemSelector: ".card-container"})
...
jQuery(document).ready(function () {
    jQuery(".img-carousel").owlCarousel({
        ...
        dots: !1,
        navText: ['<i class="ti-arrow-left"></i>', '<i class="ti-arrow-right"></i>'],
        responsive: {0: {items: 1}, 480: {items: 2}, 1024: {items: 3}, 1400: {items: 3.7}}
        ...
        dots: !1,
        navText: ['<i class="ti-arrow-left"></i>', '<i class="ti-arrow-right"></i>'],
        responsive: {0: {items: 4}, 480: {items: 6}, 1024: {items: 8}, 1400: {items: 12}}
        ...
        dots: !0,
        navText: ['<i class="ti-arrow-left"></i>', '<i class="ti-arrow-right"></i>'],
        responsive: {0: {items: 1}, 480: {items: 1}, 1024: {items: 1}, 1200: {items: 1}}
        ...
        dots: !1,
        navText: ['<i class="ti-arrow-left"></i>', '<i class="ti-arrow-right"></i>'],
        responsive: {0: {items: 1}, 480: {items: 1}, 767: {items: 2}, 1000: {items: 2}}
        ...
        dots: !1,
        navText: ['<i class="ti-arrow-left"></i>', '<i class="ti-arrow-right"></i>'],
        responsive: {0: {items: 1}, 480: {items: 1}, 767: {items: 2}, 1000: {items: 3}}
        ...
        autoplay: 3e3,
        navText: ['<i class="ti-arrow-left"></i>', '<i class="ti-arrow-right"></i>'],
        responsive: {0: {items: 1}, 480: {items: 1}, 767: {items: 2}, 1000: {items: 4}}
        ...
        responsive: {0: {items: 1}, 480: {items: 1}, 991: {items: 1}, 1000: {items: 1}}
        ...
        navText: ['<i class="fa fa-angle-left"></i>', '<i class="fa fa-angle-right"></i>'],
        responsive: {
            0: {items: 1, stagePadding: 60, margin: 15},
            480: {items: 1, margin: 15, stagePadding: 60},
            768: {items: 1},
            1000: {items: 1.5}
        }
        ...
        autoplay: 3e3,
        navText: ['<i class="la la-arrow-left"></i>', '<i class="la la-arrow-right"></i>'],
        responsive: {0: {items: 1}, 480: {items: 2}, 700: {items: 2}, 1024: {items: 3}, 1200: {items: 4}}
...
!function (e) {
    ...
    e.ui = e.ui || {}, e.extend(e.ui, {
        ...
        data: e.expr.createPseudo ? e.expr.createPseudo(function (t) {
            ...
            var i = e.attr(t, "tabindex"), s = isNaN(i);
            return (s || i >= 0) && a(t, !s)
        }
    }), e("<a>").outerWidth(1).jquery || e.each(["Width", "Height"], function (t, i) {
        var s = "Width" === i ? ["Left", "Right"] : ["Top", "Bottom"], n = i.toLowerCase(), a = {
    ...
    var u = 0, r = Array.prototype.slice;
    e.cleanData = function (t) {
        ...
        }), o.prototype = e.widget.extend(u, {widgetEventPrefix: a && u.widgetEventPrefix || t}, r, {
            constructor: o,
            namespace: h,
            widgetName: t,
            widgetFullName: n
        ...
        for (var i, s, n = r.call(arguments, 1), a = 0, o = n.length; a < o; a++) for (i in n[a]) s = n[a][i], n[a].hasOwnProperty(i) && void 0 !== s && (e.isPlainObject(s) ? t[i] = e.isPlainObject(t[i]) ? e.widget.extend({}, t[i], s) : e.widget.extend({}, s) : t[i] = s);
        return t
    }, e.widget.bridge = function (t, i) {
        var s = i.prototype.widgetFullName || t;
        e.fn[t] = function (n) {
            var a = "string" == typeof n, o = r.call(arguments, 1), u = this;
        ...
        e.Widget.prototype["_" + t] = function (s, n, a) {
            ...
            "number" == typeof (n = n || {}) && (n = {duration: n}), o = !e.isEmptyObject(n), n.complete = a, n.delay && s.delay(n.delay), o && e.effects && e.effects.effect[u] ? s[t](n) : u !== t && s[u] ? s[u](n.duration, n.easing, a) : s.queue(function (i) {
    ...
    e.widget("ui.mouse", {
        ...
        _createHandles: function () {
            var t, i, s = this.options,
                n = this.element.find(".ui-slider-handle").addClass("ui-state-default ui-corner-all"), a = [];
        ...
        _refreshValue: function () {
            var t, i, s, n, a, o = this.options.range, u = this.options, r = this, h = !this._animateOff && u.animate,
                l = {};
            this.options.values && this.options.values.length ? this.handles.each(function (s) {
                i = (r.values(s) - r._valueMin()) / (r._valueMax() - r._valueMin()) * 100, l["horizontal" === r.orientation ? "left" : "bottom"] = i + "%", e(this).stop(1, 1)[h ? "animate" : "css"](l, u.animate), !0 === r.options.range && ("horizontal" === r.orientation ? (0 === s && r.range.stop(1, 1)[h ? "animate" : "css"]({left: i + "%"}, u.animate), 1 === s && r.range[h ? "animate" : "css"]({width: i - t + "%"}, {
                    queue: !1,
                    duration: u.animate
            ...
            }) : (s = this.value(), n = this._valueMin(), a = this._valueMax(), i = a !== n ? (s - n) / (a - n) * 100 : 0, l["horizontal" === this.orientation ? "left" : "bottom"] = i + "%", this.handle.stop(1, 1)[h ? "animate" : "css"](l, u.animate), "min" === o && "horizontal" === this.orientation && this.range.stop(1, 1)[h ? "animate" : "css"]({width: i + "%"}, u.animate), "max" === o && "horizontal" === this.orientation && this.range[h ? "animate" : "css"]({width: 100 - i + "%"}, {
                queue: !1,
                duration: u.animate
...
function addSwitcher() {
    var e = window.location.href, i = "", a = "";
    e.indexOf("xhtml-rtl") > -1 ? (i = e.replace("xhtml-rtl", "xhtml"), a = e) : (a = e.replace("xhtml", "xhtml-rtl"), i = e);
    0 == $("#dzSwitcher").length && jQuery("body").append(r)
}

jQuery(window).on("load", function () {
    jQuery(".styleswitcher").animate({left: "-220px"}), jQuery(".styleswitcher-right").animate({
        right: "-220px",
        left: "auto"
    ...
    addSwitcher(), jQuery(".switch-btn").on("click", function () {
        jQuery(this).hasClass("open") ? (jQuery(this).addClass("closed"), jQuery(this).removeClass("open"), jQuery(".styleswitcher").animate({left: "-220px"}), jQuery(".styleswitcher-right").animate({
            right: "-220px",
            left: "auto"
        })) : jQuery(this).hasClass("closed") && (jQuery(this).addClass("open"), jQuery(this).removeClass("closed"), jQuery(".styleswitcher").animate({left: "0"}), jQuery(".styleswitcher-right").animate({
            right: "0",
            left: "auto"
        }))
    }), jQuery(".skin-1").on("click", function () {
        return jQuery(".skin").attr("href", "css/skin/skin-1.css"), jQuery(".logo-dark img").attr("src", "images/logo.png"), jQuery(".logo-white img").attr("src", "images/logo-white.png"), jQuery(".logo-center .logo-c").attr("src", "images/logo-center.png"), !1
    }), jQuery(".skin-2").on("click", function () {
        return jQuery(".skin").attr("href", "css/skin/skin-2.css"), jQuery(".logo-dark img").attr("src", "images/logo-2.png"), jQuery(".logo-white img").attr("src", "images/logo-white-2.png"), jQuery(".logo-center .logo-c").attr("src", "images/logo-center-2.png"), !1
    }), jQuery(".skin-3").on("click", function () {
        return jQuery(".skin").attr("href", "css/skin/skin-3.css"), jQuery(".logo-dark img").attr("src", "images/logo-3.png"), jQuery(".logo-white img").attr("src", "images/logo-white-3.png"), jQuery(".logo-center .logo-c").attr("src", "images/logo-center-3.png"), !1
    }), jQuery(".skin-4").on("click", function () {
        return jQuery(".skin").attr("href", "css/skin/skin-4.css"), jQuery(".logo-dark img").attr("src", "images/logo-4.png"), jQuery(".logo-white img").attr("src", "images/logo-white-4.png"), jQuery(".logo-center .logo-c").attr("src", "images/logo-center-4.png"), !1
    }), jQuery(".skin-5").on("click", function () {
        return jQuery(".skin").attr("href", "css/skin/skin-5.css"), jQuery(".logo-dark img").attr("src", "images/logo-5.png"), jQuery(".logo-white img").attr("src", "images/logo-white-5.png"), jQuery(".logo-center .logo-c").attr("src", "images/logo-center-5.png"), !1
    }), jQuery(".skin-6").on("click", function () {
        return jQuery(".skin").attr("href", "css/skin/skin-6.css"), jQuery(".logo-dark img").attr("src", "images/logo-6.png"), jQuery(".logo-white img").attr("src", "images/logo-white-6.png"), jQuery(".logo-center .logo-c").attr("src", "images/logo-center-6.png"), !1
    }), jQuery(".skin-7").on("click", function () {
        return jQuery(".skin").attr("href", "css/skin/skin-7.css"), jQuery(".logo-dark img").attr("src", "images/logo-7.png"), jQuery(".logo-white img").attr("src", "images/logo-white-7.png"), jQuery(".logo-center .logo-c").attr("src", "images/logo-center-7.png"), !1
    }), jQuery(".skin-8").on("click", function () {
        return jQuery(".skin").attr("href", "css/skin/skin-8.css"), jQuery(".logo-dark img").attr("src", "images/logo-8.png"), jQuery(".logo-white img").attr("src", "images/logo-white-8.png"), jQuery(".logo-center .logo-c").attr("src", "images/logo-center-8.png"), !1
    }), jQuery(".skin-9").on("click", function () {
        return jQuery(".skin").attr("href", "css/skin/skin-9.css"), jQuery(".logo-dark img").attr("src", "images/logo-9.png"), jQuery(".logo-white img").attr("src", "images/logo-white-9.png"), jQuery(".logo-center .logo-c").attr("src", "images/logo-center-9.png"), !1
    }), jQuery(".skin-10").on("click", function () {
        return jQuery(".skin").attr("href", "css/skin/skin-10.css"), jQuery(".logo-dark img").attr("src", "images/logo-10.png"), jQuery(".logo-white img").attr("src", "images/logo-white-10.png"), jQuery(".logo-center .logo-c").attr("src", "images/logo-center-10.png"), !1
        ...
        jQuery(".menubar-view li").removeClass("active"), jQuery(this).addClass("active")
    }), jQuery(".menubar-left").on("click", function () {
        jQuery(".page-wraper").addClass("sidemenu"), jQuery(".header-nav").addClass("sidenav content-scroll"), setTimeout(function () {
            Lavi.headerResize()
        }, 1e3), Lavi.customScroll(), Lavi.dzTheme()
    }), jQuery(".menubar-top").on("click", function () {
        jQuery(".page-wraper").removeClass("sidemenu"), jQuery(".header-nav").removeClass("sidenav"), setTimeout(function () {
            Lavi.headerResize()
        }, 1e3);
        ...
        jQuery(".content-scroll").removeClass("content-scroll mCustomScrollbar _mCS_1 mCS_no_scrollbar"), jQuery(".header-nav").empty(), jQuery(".header-nav").append(e).append(i).append(a)
...
function themeFramePadding() {
    ...
    "" == e && (e = 20), $("#slider-range-3").length > 0 && $("#slider-range-3").unbind().slider({
        min: 20,
        max: 80,
        value: e,
        animate: "slow",
...
function setThemePanel() {
    jQuery.each(themeOption, function (e, i) {
        if (themeOptionItemValue = getCookie(i + "_value"), "" != themeOptionItemValue) if ("themeStandardColor" == i) jQuery(".skin").attr("href", themeOptionItemValue + ".css"), setThemeLogo(i); else if ("themeFullColor" == i) jQuery(".skin").attr("href", themeOptionItemValue + ".css"), setThemeLogo(i); else if ("layout" == i) jQuery("." + i + "-view li").removeClass("active"), jQuery("." + i + "-view").find("." + themeOptionItemValue).addClass("active"), "frame" == themeOptionItemValue ? (jQuery("#ThemeRangeSlider").show("slow"), jQuery("body").addClass(themeOptionItemValue), themeOptionFrameValue = getCookie("frame_value"), "" == themeOptionFrameValue && (themeOptionFrameValue = 20), jQuery("#FramePadding").val(themeOptionFrameValue + "px"), jQuery("#bg").css("padding", themeOptionFrameValue + "px")) : jQuery("body").addClass(themeOptionItemValue); else if ("header" == i) jQuery("." + i + "-view li").removeClass("active"), "sticky-header" == themeOptionItemValue ? jQuery("." + i + "-view").find(".header-fixed").addClass("active") : "sticky-no" == themeOptionItemValue && jQuery("." + i + "-view").find(".header-static").addClass("active"), jQuery(".main-bar-wraper").addClass(themeOptionItemValue); else if ("menubar" == i) {
            if (jQuery("." + i + "-view li").removeClass("active"), "left" == themeOptionItemValue) jQuery("." + i + "-view").find(".menubar-left").addClass("active"), jQuery(".page-wraper").addClass("sidemenu"), jQuery(".header-nav").addClass("sidenav content-scroll"), setTimeout(function () {
                Lavi.headerResize()
            }, 1e3), Lavi.customScroll(), Lavi.dzTheme(); else if ("top" == themeOptionItemValue) {
                jQuery("." + i + "-view").find(".menubar-top").addClass("active"), jQuery(".page-wraper").removeClass("sidemenu"), jQuery(".header-nav").removeClass("sidenav"), setTimeout(function () {
                    Lavi.headerResize()
                }, 1e3);
                ...
                jQuery(".content-scroll").removeClass("content-scroll mCustomScrollbar _mCS_1 mCS_no_scrollbar"), jQuery(".header-nav").empty(), jQuery(".header-nav").append(a).append(r).append(s)
            }
        } else "bgColor" == i ? (jQuery("#bg").css("background-color", themeOptionItemValue), jQuery("#bg").css("background-image", "")) : "bgImage" == i ? jQuery("#bg").css({backgroundImage: "url(" + themeOptionItemValue + ")"}) : "bgPatten" == i && (jQuery("#bg").css({backgroundImage: "url(" + themeOptionItemValue + ")"}), jQuery("#bg").css("background-size", "auto"))
    }), logoValue = getCookie("logo_value"), "" != logoValue && (jQuery(".logo-white img").attr("src", logoValue), jQuery(".logo-dark img").attr("src", logoValue), jQuery(".logo-center .logo-c").attr("src", logoValue))
}

function setThemeLogo(e) {
    var i = getCookie(e + "_logo");
    "" != i && (jQuery(".logo-white img").attr("src", i), jQuery(".logo-dark img").attr("src", i), jQuery(".logo-center .logo-c").attr("src", i))
}
...
themeOption.layout = ["wide", "boxed", "frame", "frame_value", "layout_value"], themeOption.themeStandardColor = ["skin-1", "skin-2", "skin-3", "skin-4", "skin-5", "skin-6", "skin-7", "skin-8", "skin-9", "skin-10", "themeStandardColor_value", "themeStandardColor_logo"], themeOption.themeFullColor = ["css/skin/skin-1", "css/skin/skin-2", "css/skin/skin-3", "css/skin/skin-4", "css/skin/skin-5", "css/skin/skin-6", "css/skin/skin-7", "css/skin/skin-8", "css/skin/skin-9", "css/skin/skin-10", "themeFullColor_value", "themeFullColor_logo"], themeOption.header = ["fixed", "static", "header_value"], themeOption.menubar = ["left", "top", "menubar_value"], themeOption.bgColor = ["#4fa750", "#d2151e", "#fdb400", "#0086f0", "#6a1a1f", "#019444", "#00c6ff", "#e87800", "#cc9f5a", "#bd5ec6", "bgColor_value"], themeOption.bgImage = ["bg1.jpg", "error-404.html", "error-404.html", "error-404.html", "bgImage_value"], themeOption.bgPatten = ["pt1.jpg", "error-404.html", "error-404.html", "error-404.html", "error-404.html", "error-404.html", "error-404.html", "error-404.html", "error-404.html", "error-404.html", "error-404.html", "error-404.html", "bgPatten_value"], jQuery(document).ready(function () {
    jQuery(".theme-panel-save li a, .theme-panel-save li img").on("click", function () {
        var e = jQuery(this).attr("dir"), i = jQuery(this).parent().parent().attr("val");
        if ("bgColor" == i) deleteCookie("bgImage_value"), deleteCookie("bgPatten_value"); else if ("bgImage" == i) deleteCookie("bgColor_value"), deleteCookie("bgPatten_value"); else if ("bgPatten" == i) deleteCookie("bgColor_value"), deleteCookie("bgImage_value"); else if ("themeStandardColor" == i) deleteCookie("themeFullColor_value"); else if ("themeFullColor" == i) {
            setCookie("logo_value", jQuery(this).attr("logo"), 1), deleteCookie("themeStandardColor_value")
